...
{
    /// <summary>
    /// A static class to create and manage password hash securely
    /// </summary>
    public static class PasswordStorage
    {
        ...
        public const int PBKDF2_ITERATIONS = 64000;//we are deliberately slowing down the hashing to avoid brute-force hack
        ...
        /// <summary>
        /// Generate a hash code for the provided password and a random SALT
        /// </summary>
        /// <returns>The generated hash which also include the SALT</returns>
        ...
        /// <summary>
        /// Verify if the provided password yields to the provided hash
        /// </summary>
